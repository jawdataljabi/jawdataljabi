...
- **SignSync** - Real-time ASL → text → speech for live meeting use  
  https://github.com/jawdataljabi/SignSync  
- **Car Dealership Chatbot** - NLP assistant with NER (Named Entity Recognition) + sentiment analysis + embeddings + recommendations  
  https://github.com/mika-dagostino/autobot-api
